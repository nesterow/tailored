    ...
    return (
        <div className={props.className} style={{
            ...
            <svg viewBox="0 0 100 126" width={props.width} height="100%">
                <g>
                    <path style={{transition: transitionTime[0]}} d={path} fill="none" stroke={colors[0]} stroke-width=".1" stroke-linecap="round"/>
                    <path style={{transition: transitionTime[1]}} d={path} fill="none" stroke={colors[1]} stroke-width=".1" stroke-linecap="round"/>
                    <path style={{transition: transitionTime[2]}} d={path} fill="none" stroke={colors[2]} stroke-width=".1" stroke-linecap="round" />
                </g>
            </svg>
        </div>
    )
