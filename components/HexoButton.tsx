...
const Styles = (props: HexoButtonProps, extend?: {[key: string]:string}) => ({
    width: props.width,
...
export default function HexoButton(props: HexoButtonProps){
    return (
        <a {...props} class="relative min-w-[50px] min-h-[50px]" style={Styles(props)}>
            <svg viewBox="0 0 100 100" width="100%" class="-z-10" style={{
                transform: `rotate(${props.rotate || 0}deg)`,
            }}>
                <polygon id="svg-hex" points={hexagon.join(' ')} style={{
                    transition: 'all 0.2s',
                }}/>
            </svg>
